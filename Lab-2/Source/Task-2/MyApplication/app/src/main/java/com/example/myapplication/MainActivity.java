    ...
    public  void validate(View view){
        ...
        for(i=0;i<usernames.length;i++) {
            if ( username.equals(usernames[i]) && password.equals(passwords[i])) {
                Intent redirect = new Intent(MainActivity.this, HomeActivity.class);
                redirect.putExtra("USER_NAME", "Lakshman");
                redirect.putExtra("BIRTHDAY", "10/07/1995");
                redirect.putExtra("EMAIL", "lakshmankumarmettu@gmail.com");
                redirect.putExtra("LOCATION","kansas");
                redirect.putExtra("ID", ((String) null));
                redirect.putExtra("IMAGE_URL", ((String) null));
                redirect.putExtra("GENDER","male");
                MainActivity.this.startActivity(redirect);
                break;
            }
        }
