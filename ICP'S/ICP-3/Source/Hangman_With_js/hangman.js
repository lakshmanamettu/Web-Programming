...
var Hangman = (function () {
    ...
    function Hangman(elId) {
        ...
        // Dom is ready
        this.elId       = elId;
        this.words      = ['SPARKLING', 'RAINBOW', 'CODER','WATERFALL'];
        this.hints      = {'SPARKLING': ['glistering,glittering,charming'],'RAINBOW': ['full colors'],'CODER': ['techie', 'ethical hacker', 'programmer'] , 'WATERFALL': ['rainfall']};
        this.hintimages = {'SPARKLING':'./charming.jpg','RAINBOW':'./rainbow.jpg','CODER':'./coder.jpg', 'WATERFALL':'./waterfall.jpg'};
    }
    ...
    Hangman.prototype.hint = function() {
        this.HINTS = this.hints[this.WORD];
        document.getElementById('hinttext').innerHTML = "<p>" + this.HINTS[0] + "</p>";
        this.HINTIMAGES = this.hintimages[this.WORD];
        document.getElementById('hintimage').innerHTML = "<img src=\"" + this.HINTIMAGES + "\" width='100px' height='100px'></img>";
    };
